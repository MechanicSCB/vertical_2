...
import CursorArrowIcon from "../../../Svg/CursorArrowIcon.vue";
import ClickEffectIcon from "../../../Svg/ClickEffecticon.vue";
...
<template>
    <div class="product-card h-full relative border rounded-3xl bg-ui-section overflow-hidden pb-6 flex flex-col">
        ...
        <div class="text-ui-text-secondary flex flex-col">
            ...
            <!-- BUY IN ONE CLICK -->
            <button class="mt-2 mx-auto flex hover:text-ui-link-hover hover:fill-ui-link-hover">
                <CursorArrowClickedIcon class="w-5"/>
                Купить в один клик
            </button>

            <!-- OPT LINK -->
            <Link href="#" class="text-center" preserve-scroll>специальные&nbsp;цены для&nbsp;юридических&nbsp;лиц</Link>
        </div>
