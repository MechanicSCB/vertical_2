...
import CartItem from "@/Pages/Cart/Partials/CartItem.vue";
...
<template>
    ...
    <div class="mx-auto px-9 max-w-[1656px]">
        ...
        <div v-if="Object.keys(cart.products).length">
            ...
            <div class="flex flex-col xl:flex-row gap-x-8">
                ...
                <div class="mb-24 w-full xl:w-2/3 2xl:w-3/4">
                    <div class="hidden md:grid grid-cols-5 text-ui-text-secondary mb-9">
                        ...
                        <CartItem v-for="product in cart.products" :product="product"/>
                    </div>
        ...
        <!-- TEST ADD TO CART -->
        <div class="mt-10 hidden md:grid grid-cols-3 gap-2">
