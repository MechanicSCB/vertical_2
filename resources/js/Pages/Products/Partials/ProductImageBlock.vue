...
<template>
    ...
    <div @click="showModalImg=!showModalImg" v-if="showModalImg"
         class="top-0 left-0 p-10 flex items-center min-h-screen fixed overflow-auto bg-[rgba(0,0,0,0.8)] w-full h-full z-50">
        ...
        <button @click.stop="slideUp" class="absolute top-1/2 left-2 w-10 h-10 bg-black opacity-50 hover:opacity-75">
        ...
        <button @click.stop="slideDown" class="absolute top-1/2 right-2 w-10 h-10 bg-black opacity-50 hover:opacity-75">
    ...
    <div class="flex gap-9">
        <!-- IMAGE CARD -->
        <div class="relative border rounded-3xl overflow-hidden h-[510px] justify-between flex items-center">
            <!-- FAVORITE -->
